...
class EpisodeRunner:
    ...
    async def run(
        ...
        try:
            ...
            # Setup trace directory (for screenshots, not otel)
            trace_path = None
            if self.trace_dir:
    ...
    async def _run_turn(
        ...
        # 7. Execute action with timing breakdown
        ...
        try:
            ...
            turn_log.action_timing = action_timing  # Store detailed timing breakdown
        except Exception as e:
